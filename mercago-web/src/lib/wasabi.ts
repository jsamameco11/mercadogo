...
export async function uploadImage({
  ...
  if (!wasabiConfigured()) {
    throw new Error("El almacenamiento de imágenes no está configurado (faltan variables de entorno).");
  }
...
// La cuenta de Wasabi bloquea lectura pública de objetos, así que las
// imágenes se sirven a través de /m/[...path] en esta misma app, que hace
// streaming server-side con las credenciales privadas.
